...
document.querySelector('.out-5').textContent = t5.call(document.querySelector('.i-5'));
...
let t11 = t1.bind(document.querySelector('.out-11'));
...
let t12 = max.bind(document.querySelector('.out-12'));
